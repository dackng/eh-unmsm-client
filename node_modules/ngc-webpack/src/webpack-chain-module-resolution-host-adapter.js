...
var WebpackChainModuleResolutionHostAdapter = (function (_super) {
    ...
    function WebpackChainModuleResolutionHostAdapter(host, webpackWrapper) {
        ...
        _this._loader = new webpack_resource_loader_1.WebpackResourceLoader(_this.webpackWrapper.compiler.createCompilation(), !!webpackWrapper.plugin.options.resourceOverride);
    ...
    WebpackChainModuleResolutionHostAdapter.prototype.readResource = function (path) {
        ...
        if (newPath === '') {
            ...
            return this._loader.get(newPath)
                .then(function (source) { return Promise.resolve(_this.webpackWrapper.sourceTransformer(newPath, source)); });
        }
    };
